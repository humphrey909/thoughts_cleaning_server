package com.async.main.common.jwt;
...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${jwt.secret:c2lsdmVybmluZS10ZWNoLXNwcmluZy1ib290LWp3dC10dXRvcmlhbC1zZWNyZXQtc2lsdmVybmluZS10ZWNoLXNwcmluZy1ib290LWp3dC10dXRvcmlhbC1zZWNyZXQ=}") String secretKey) {
